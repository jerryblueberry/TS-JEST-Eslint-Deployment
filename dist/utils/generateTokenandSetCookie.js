...
const generateTokenAndSetCookie = (userId, userName, userRole, res) => {
    const token = jsonwebtoken_1.default.sign({ userId, userName, userRole }, "MXIUuw6u5Ty0Ecih3XCjZ1+0575N2OTu0x9gsOl6pBc=", {
        expiresIn: "15d",
    });
